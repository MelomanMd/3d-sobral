...
export const translations = {
  de: {
    ...
    // Sobral Top Bar & Navigation Ribbon
    top_announcement: 'GROSSE AUSWAHL - TOP MARKEN - PERSÖNLICHE BERATUNG',
    top_portal: 'Kundenportal',
    top_service: 'Service',
    top_catalogs: 'Kataloge',
    top_about: 'Über uns',
    top_contact: 'Kontakt',
    search_placeholder: 'ICH SUCHE NACH...',
    nav_workwear: 'Arbeitskleidung',
    nav_shoes: 'Arbeitsschuhe',
    nav_tech: 'Technische Produkte',
    nav_fall: 'Fallschutz',
    nav_brands: 'Markenkompetenz',
    nav_studio: '3D Custom Studio',
    ...
    tab_logos: 'Logos',
    tab_fitting: '3D-Anprobe',

    // Fitting Panel
    fitting_title: 'Anprobe am 3D-Model',
    fitting_subtitle: 'Komplett-Look & Mitarbeiter-Ausstattung',
    fitting_badge: '3D-Outfit Simulator',
    fitting_top_card: 'Aktuelles Oberteil (Übernommen)',
    fitting_bottom_card: 'Passende Arbeitshose',
    fitting_shoes_card: 'Sicherheitsschuhe',
    fitting_headwear_card: 'Kopfschutz / Zubehör',
    fitting_trousers_navy: 'Navy Dunkelblau',
    fitting_trousers_black: 'Schwarz Anthrazit',
    fitting_trousers_grey: 'Mittelgrau',
    fitting_shoe_black: 'SOBRAL Pro Safety Boot S3',
    fitting_head_helmet: 'KASK PRIMERO AIR Schutzhelm',
    fitting_head_beanie: 'SOBRAL Wintermütze',
    fitting_head_none: 'Kein Kopfschutz',
    fitting_total_price: 'Komplettpreis Outfit',
    fitting_download_look: 'Komplett-Look herunterladen',
    fitting_switch_back: 'Zurück zum Einzelteil',

    // Colors Panel
    section_pattern: 'Sportstil (Muster)',
    section_color_zone: 'Farbzonen & Elemente',
    zone_primary: 'Hauptkörper (Body)',
    zone_accent: 'Schultereinsätze (Akzent)',
    zone_collar: 'Kragen (Bündchen)',
    zone_secondary: 'Sekundärakzente',
    section_palette: 'Sport-Farbpalette',

    // Patterns
    pattern_solid: 'Klassisch Einfarbig (Solid)',
    pattern_raglan_shoulder: 'Kontrast-Schultern (Raglan / 2-Farbig)',
    pattern_vexa: 'Vexa Sport (Dynamisch)',
    pattern_racing: 'Speed Racing (Streifen)',
    pattern_cyber_hex: 'Cyber Mesh / Waben',
    pattern_gradient: 'Farbverlauf Flow (Ombre)',
    ...
    // Creation Screen & Add Product
    creation_badge: '✨ 3D-Rekonstruktion',
    creation_title: 'Neues Produkt erstellen',
    creation_subtitle: 'Laden Sie 4 Fotos hoch – das System generiert automatisch die exakte 3D-Kopie mit allen Elementen.',
    creation_photos_heading: 'Produktfotos für 3D-Rekonstruktion (4 Ansichten)',
    slot_front: '1. Vorne (Front)',
    slot_back: '2. Hinten (Back)',
    slot_left: '3. Links (Left)',
    slot_right: '4. Rechts (Right)',
    badge_front: 'Vorderseite',
    badge_back: 'Rückseite',
    badge_left: 'Linke Seite',
    badge_right: 'Rechte Seite',
    label_product_name: 'Produktname',
    label_product_cat: 'Kategorie',
    label_product_silhouette: '3D-Passform & Schnitt',
    label_pattern: 'Schnitt & Design-Muster',
    label_body_color: 'Hauptfarbe (Körper)',
    label_accent_color: 'Akzentfarbe (Schultern / Details)',
    btn_generate_studio: '3D-Modell generieren & Studio starten',
    btn_cancel: 'Abbrechen',
    analysis_elements_detected: '✨ Elemente & Farben erkannt',
    analysis_tanktop_detected: 'Modell: Ärmelloses Shirt / Tank Top erkannt',
    analysis_raglan_detected: 'Schnitt: Kontrast-Schultern (Raglan)',
    analysis_solid_detected: 'Schnitt: Klassisch Einfarbig (Solid)',
    analysis_body_pill: 'Körper',
    analysis_shoulders_pill: 'Schultern',
    analysis_collar_pill: 'Kragen',
    ...
    cat_headwear: 'Mützen, Caps & Helme',
    sil_tshirt: 'T-Shirt (Klassisch)',
    sil_tanktop: 'Ärmelloses Shirt / Tank Top (Sleeveless)',
  ...
  en: {
    ...
    // Sobral Top Bar & Navigation Ribbon
    top_announcement: 'WIDE SELECTION - TOP BRANDS - PERSONAL CONSULTING',
    top_portal: 'Customer Portal',
    top_service: 'Service',
    top_catalogs: 'Catalogs',
    top_about: 'About Us',
    top_contact: 'Contact',
    search_placeholder: 'SEARCHING FOR...',
    nav_workwear: 'Workwear',
    nav_shoes: 'Safety Shoes',
    nav_tech: 'Technical Products',
    nav_fall: 'Fall Protection',
    nav_brands: 'Brand Competence',
    nav_studio: '3D Custom Studio',
    ...
    tab_logos: 'Logos',
    tab_fitting: '3D Try-On',

    // Fitting Panel
    fitting_title: 'Try-On on 3D Model',
    fitting_subtitle: 'Complete Look & Staff Outfitting',
    fitting_badge: '3D Outfit Simulator',
    fitting_top_card: 'Configured Top (Applied)',
    fitting_bottom_card: 'Matching Work Trousers',
    fitting_shoes_card: 'Safety Footwear',
    fitting_headwear_card: 'Headwear / Accessories',
    fitting_trousers_navy: 'Navy Dark Blue',
    fitting_trousers_black: 'Black Anthracite',
    fitting_trousers_grey: 'Medium Grey',
    fitting_shoe_black: 'SOBRAL Pro Safety Boot S3',
    fitting_head_helmet: 'KASK PRIMERO AIR Helmet',
    fitting_head_beanie: 'SOBRAL Winter Beanie',
    fitting_head_none: 'No Headwear',
    fitting_total_price: 'Complete Outfit Price',
    fitting_download_look: 'Download Full Look',
    fitting_switch_back: 'Back to Single Product',

    // Colors Panel
    section_pattern: 'Sport Style (Pattern)',
    section_color_zone: 'Color Zones & Elements',
    zone_primary: 'Main Body',
    zone_accent: 'Shoulder Inserts (Accent)',
    zone_collar: 'Collar Ribbing',
    zone_secondary: 'Secondary Accents',
    section_palette: 'Sports Palette',

    // Patterns
    pattern_solid: 'Clean Solid Color',
    pattern_raglan_shoulder: 'Contrast Shoulders (Raglan)',
    pattern_vexa: 'Vexa Sport (Dynamic)',
    pattern_racing: 'Speed Racing (Stripes)',
    pattern_cyber_hex: 'Cyber Mesh / Hex',
    pattern_gradient: 'Gradient Flow (Ombre)',
    ...
    // Creation Screen & Add Product
    creation_badge: '✨ 3D Reconstruction',
    creation_title: 'Create New Product',
    creation_subtitle: 'Upload 4 photos – the system automatically reconstructs the exact 3D model with all parts.',
    creation_photos_heading: 'Product Photos for 3D Reconstruction (4 Views)',
    slot_front: '1. Front (Front)',
    slot_back: '2. Back (Back)',
    slot_left: '3. Left (Left)',
    slot_right: '4. Right (Right)',
    badge_front: 'Front Side',
    badge_back: 'Back Side',
    badge_left: 'Left Side',
    badge_right: 'Right Side',
    label_product_name: 'Product Name',
    label_product_cat: 'Category',
    label_product_silhouette: '3D Fit & Silhouette',
    label_pattern: 'Cut & Design Pattern',
    label_body_color: 'Main Body Color',
    label_accent_color: 'Accent Color (Shoulders / Details)',
    btn_generate_studio: 'Generate 3D Model & Launch Studio',
    btn_cancel: 'Cancel',
    analysis_elements_detected: '✨ Elements & Colors Detected',
    analysis_tanktop_detected: 'Model: Sleeveless Shirt / Tank Top Detected',
    analysis_raglan_detected: 'Cut: Contrast Shoulders (Raglan)',
    analysis_solid_detected: 'Cut: Solid Single Color',
    analysis_body_pill: 'Body',
    analysis_shoulders_pill: 'Shoulders',
    analysis_collar_pill: 'Collar',
    ...
    cat_headwear: 'Caps, Beanies & Helmets',
    sil_tshirt: 'T-Shirt (Classic)',
    sil_tanktop: 'Sleeveless Shirt / Tank Top (Sleeveless)',
